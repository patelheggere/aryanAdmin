...
public class AdminBaseApplication extends Application {
    private static AdminBaseApplication mInstance;
    ...
    public static synchronized AdminBaseApplication getInstance() {
        return mInstance;
    }
